...
Controlled vocabularies owned by the predictive engine library.
...
Split out of app/models/enums.py during the engine relocation (see
specs/lessons.md): these 4 enums are engine-owned; the 5 orchestration
enums (IntentType, ClarificationReason, OrganismGroundingFailureStage,
SessionStatus, RetrievalConfidenceLevel) stay in app/models/enums.py.
"""
