...
class TestComBaseOrganism:
    ...
    def test_from_string_exact_match(self):
        ...
        assert (
            ComBaseOrganism.from_string("lm") == ComBaseOrganism.LISTERIA_MONOCYTOGENES
        )
