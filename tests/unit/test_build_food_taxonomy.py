...
ALIGNMENT_HEADER = (
    "foodex2_code,foodex2_name,treatment,ptm_category,sub_anchors,notes\n"
)
...
class TestDescendants:
    ...
    def test_other_hierarchies_ignored(self):
        terms = {
            ...
            "Y": Term(
                code="Y", name="y", scope_note="", parents={"expo": "OTHER"}
            ),  # not in report
        }
...
class TestBuildRow:
    def test_simple_direct_anchor(self):
        ...
        anchor = AnchorSpec(
            code="A031E", ptm_category="eggs", apply_species_override=False
        )
    ...
    def test_a0bxt_anchor_applies_poultry_override(self):
        ...
        anchor = AnchorSpec(
            code="A0BXT", ptm_category="meat", apply_species_override=True
        )
    ...
    def test_orphan_parent_handled(self):
        ...
        anchor = AnchorSpec(
            code="X", ptm_category="grain", apply_species_override=False
        )
